...
const double calendarWeekPickerIconSize = 20.0;
const double calendarWeekSwitcherIconSize = 26.5;
const double calendarWeekSwitcherSize = 44.0;
const double calendarWeekPickerDayMaxSize = 42.0;
const double calendarWeekPickerRowSize = 46.0;
const double calendarWeekPickerHorizontalPadding = 11.0;
...
const double calendarDateWeekPickerHeight = 136.0;
const double calendarDateTimeWeekPickerHeight = 182.0;
